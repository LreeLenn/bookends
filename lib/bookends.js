...
function aggregate(records, aggregation) {
  // hardcoding to 'count' for now
  return {
...
function resolveAggregations(record, hydration) {
  ...
  _.each(aggregations, function(aggregation) {
    record[aggregation.relation] = aggregate(record[aggregation.relation], aggregation.aggregation);
  });

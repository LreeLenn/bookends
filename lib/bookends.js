...
function getRelations(spec, Model, prefix) {
  ...
  return _.reduce(relationSpecs, function(relation, relationSpec) {
    ...
    _.each(subRelationSpecs, function(subRelationSpec) {
      var ChildModel = getChildModel(Model, subRelationSpec.relation);
      var subRelations = getRelations([subRelationSpec], ChildModel, relationSpec.relation);
